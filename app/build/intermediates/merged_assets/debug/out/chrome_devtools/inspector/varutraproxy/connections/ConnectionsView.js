...
WebInspector.ConnectionsView = function(coulmnsVisibilitySetting)
{
    ...
    WebInspector.networkManager.addEventListener(WebInspector.NetworkManager.EventTypes.VarutraProxyConnectionsSnapshot, this._onNewConnectionsSnapshot, this);
...
WebInspector.ConnectionsView.prototype = {
    ...
    _updateSummaryBar: function()
    {
        ...
        if (!connectionsNumber) {
            ...
            this._summaryBarElement.appendChild(document.createTextNode(
                WebInspector.UIString("No connections. Maybe VarutraProxy web is not active.")));
            return;
        }
    ...
    _onAutorefreshClicked: function(e)
    {
        ...
        if (this._autorefreshToggle.toggled){
            NetworkAgent.varutraProxyStartSendingConnSnapshots("1000", this._onStartSendingConnSnapshots.bind(this));
        }else{
            NetworkAgent.varutraProxyStopSendingConnSnapshots(this._onStopSendingConnSnapshots.bind(this));
        }
    },
...
//# sourceURL=http://192.168.1.135/devtools/varutraproxy/connections/ConnectionsView.js