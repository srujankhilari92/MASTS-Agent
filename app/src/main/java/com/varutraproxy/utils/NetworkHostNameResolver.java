...
import com.varutra.webscarab.plugin.proxy.ITransparentProxyResolver;
import com.varutra.webscarab.plugin.proxy.SiteData;
...
public class NetworkHostNameResolver implements ITransparentProxyResolver{
    ...
    public static String DEFAULT_SITE_NAME = "varutraproxy.untrusted";
