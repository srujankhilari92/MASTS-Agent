...
import com.varutra.webscarab.store.sql.IStoreEventListener;
...
public class WebSocketServerCustom extends WebSocketServer implements IStoreEventListener{
    ...
    private class TestWorkerHandler extends Handler {
        ...
        private static final int MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_START = 18;
        private static final int MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_STOP = 19;
        ...
        public void handleMessage(Message msg) {
            ...
            }else if (msg.what == MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_START) {
            ...
            }else if (msg.what == MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_STOP) {
    ...
    public void onMessage(WebSocket webSocket, String arg1) {
        ...
        try {
            ...
            if (method.equalsIgnoreCase("network.VarutraProxyStartSendingConnSnapshots")){
                JSONObject params = obj.getJSONObject("params");
                String interval = params.getString("interval");
                Message msg = Message.obtain();
                msg.what = TestWorkerHandler.MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_START;
            ...
            if (method.equalsIgnoreCase("network.VarutraProxyStopSendingConnSnapshots")){
                Message msg = Message.obtain();
                msg.what = TestWorkerHandler.MESSAGE_VarutraPROXY_CONN_SNAPSHOTS_STOP;
                Bundle bundle = new Bundle();
                bundle.putString("socketId", socketId);
                bundle.putLong("id", Long.valueOf(id));
                msg.setData(bundle);
