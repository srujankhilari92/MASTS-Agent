...
import com.varutra.utils.preferences.PreferenceConstants;
...
public class VarutraProxyWebService extends Service{

    public static int VarutraPROXY_WEB_NOTIFICATION_ID = 200;
    public static boolean webServerStarted = false;
    private static Logger _logger = Logger.getLogger(VarutraProxyWebService.class.getName());
        ...
        Thread thread = new Thread()
        {
            ...
            public void run() {
                try {
                    ...
                    String webHostString = pref.getString(PreferenceConstants.PREF_WEB_GUI_HOST_ROOT, "http://Varutrap.googlecode.com/git-history/chrome_devtools_1_0/projects/VarutraProxyWeb/chrome_devtools/");
                    ...
                    Notification notification = new Notification(icon, "VarutraProxy Web activated", when);
                    ...
                    notification.setLatestEventInfo(context, "VarutraProxy Web", NotificationMessage, contentIntent);
                    
                    startForeground(VarutraPROXY_WEB_NOTIFICATION_ID, notification);
                } catch (Exception e) {
