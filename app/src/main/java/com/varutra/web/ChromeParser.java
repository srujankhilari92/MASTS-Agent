...
public class ChromeParser {
    ...
    public String getConnectionsSnapshot(boolean resolveHostNames){
        ...
        try {
            ...
            List<ConnectionDescriptor> connectionsInfo = com.varutra.utils.network.NetworkInfo.getNetworkInfo(mContext, resolveHostNames);
            ...
            responseObj.put("method", "Network.VarutraProxyConnectionsSnapshot");
