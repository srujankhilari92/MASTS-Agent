...
// VarutraProxy
// InspectorBackend.registerVarutraProxyDispatcher = InspectorBackend.registerDomainDispatcher.bind(InspectorBackend, "VarutraProxy");
InspectorBackend.registerEvent("Network.VarutraProxyConnectionsSnapshot", ["snapshot"]);
InspectorBackend.registerCommand("Network.VarutraProxyStartSendingConnSnapshots", [{"name": "interval", "type": "string", "optional": false}], ["result"]);
InspectorBackend.registerCommand("Network.VarutraProxyStopSendingConnSnapshots", [], ["result"]);

InspectorBackend.registerEvent("Network.VarutraProxyLogsFetch", ["logs"]);
InspectorBackend.registerCommand("Network.VarutraProxyStartSendingLogs", [{"name": "interval", "type": "string", "optional": false}], ["result"]);
InspectorBackend.registerCommand("Network.VarutraProxyStopSendingLogs", [], ["result"]);

InspectorBackend.registerEvent("Network.VarutraProxyConsoleMessages",["messages"]);
